...
\title{Attention-Based Model for Aspect-Oriented Sentiment Classification}
\author{Le Thi Phuong, Le Minh Binh, Bui Khanh Huyen, Tran Khanh Hung}
\date{March 2021}
...
\setcounter{page}{1}
\include{Graph-Attention-Network/chap1.tex}
\include{Graph-Attention-Network/chap2.tex}
